    ...
    <div className="legal-page grain-bg">
      ...
      <main className="container legal-page__content">
        ...
        <section>
          ...
          <p>
            Сайт может сохранять в браузере технические данные (cookies и localStorage): состав
            корзины, отметку о прочтении уведомления и служебные настройки демонстрационного режима.
