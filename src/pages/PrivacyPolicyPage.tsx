      ...
      <main className="container legal-page__content">
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              Получение заказа — в первую очередь самовывоз по адресу {MERCHANT.addressShort}.
              Доставку, если она возможна, обсуждаем при звонке.
            </li>
            <li>Наличие и окончательную цену штучных изделий подтверждаем при ответе на заявку.</li>
          </ul>
        </section>

        <p className="legal-page__updated">Редакция от 18 сентября 2026 г.</p>
      </main>
    </div>
  )
}
