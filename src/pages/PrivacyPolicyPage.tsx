      ...
      <main className="container legal-page__content">
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              данные профиля ВКонтакте (идентификатор, имя, фамилия, фото и ссылка на страницу) — только
              если вы сами вошли через VK ID при оформлении заявки. Вход не обязателен: заявку можно
              отправить и без него.
            </li>
          </ul>
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              если вы вошли через VK ID — чтобы увидеть ваш профиль ВКонтакте в панели заявок и
              быстрее найти переписку.
            </li>
          </ul>
          <p>
        ...
        <section>
          ...
          <p>
            ...
            лицам для рекламы. Для доставки в пункт выдачи адрес ПВЗ и контакты получателя могут быть
            переданы службе доставки Ozon — только чтобы оформить отправку. Храним столько, сколько
            нужно, чтобы обработать заявку и при необходимости связаться повторно, затем удаляем или
            обезличиваем.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Сайт может сохранять в браузере технические данные (cookies и localStorage / sessionStorage):
            состав корзины, отметку о прочтении уведомления, служебные настройки демонстрационного
            режима и (если вы вошли через VK ID) краткие данные профиля для оформления заявки.
            Эти данные нужны для работы витрины и не используются для рекламы третьими лицами.
          </p>
        </section>

        <p className="legal-page__updated">Редакция от 23 сентября 2026 г.</p>
      </main>
    </div>
  )
}
