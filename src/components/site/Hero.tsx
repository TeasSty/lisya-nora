      ...
      <div className="container hero__inner">
        <div className="hero__copy">
          ...
          <h1>
            Волшебство
            <br />
            <em>в каждом творении</em>
          </h1>
          <p className="hero__lead">
            Творческий сувенирный магазин, небольшой магазинчик в центре старого города. В нашем
            магазине представлены работы мастеров из Выборга и не только. Все изделия выполнены
            вручную, с огромной любовью и душой. Приходите за подарками :) за покупками и просто за
