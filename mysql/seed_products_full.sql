...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/vorona-krasotka.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/semeystvo-voron.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/stranniki.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/babka-yozhka-louhi.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/lisy-pape-mashe.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/gnomik-villi.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/figurka-moryaka.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/chudo-mishanya.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/vsyachnitsa-keramika.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/vsyachnitsa-ovechki.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/keramika-vsyachnitsa-2027.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/loshadki-keramika.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/keramicheskie-figurki.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/keramicheskiy-kon.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/svetilnik-domik.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/domik-svetilnik.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/svetilnik-keramika.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/muhomor-na-udachu.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/muhomor-kolokolchik.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/zhelud-keramika.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/suvenir-keramika.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/svistulka-kot.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/panno-derevo.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/unikalnye-ukrashenia.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/ukrashenia-farfor.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/venok-kozhanyh-tsvetov.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/broshi-kozha.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/broshka-keramika.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/broshka-brelok.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/broshki-vyazanye.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/lyagushka-podskazushka.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/brelok-gnomik.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/sova-kovka.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/sobaka-eva.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/mne-tolko-sprosit.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/shamany-lisitsy.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/poni.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/vorona-karkusha.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/krolik.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/igrushka-medved.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/istoricheskie-kukly.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/baba-yaga.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/semechko-doma.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/semechko-doma-mini.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/semechko-dela.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/kedr-talisman.webp' LIMIT 1);
...
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM products WHERE image_url = '/images/products/duhi.webp' LIMIT 1);
